...
\eje Para el sistema de la figura, describa la evolución de las (súper)manzanas y calcule laaceleración en los siguientes casos (considere $\mu_e$ = 0.4 ; $\mu_d$ = 0.2):
...
kg y m3 = 1 kg. Si bien entre las manzanas con masas m1 y m2 hay rozamiento (considere $\mu_e$ = 0.4 ; $\mu_d$ = 0.2), no lo hay entre la manzana con masa m2 y la superficie sobre la que está
