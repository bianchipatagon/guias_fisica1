...
\eje [4.4] Cinco fuerzas tiran de una caja de 4.0 kg como se muestra en la figura. Encuentre la
...
\eje [p.35] Tenemos el sistema de la figura, donde la manzana con masa m$_1$ = 6 kg y la manzana con
...
\eje [p.73] Para el sistema de la figura, describa la evolución de las (súper)manzanas y calcule laaceleración en los siguientes casos (considere $\mu_e$ = 0.4 ; $\mu_d$ = 0.2):
...
kg y m$_3$ = 1 kg. Si bien entre las manzanas con masas m1 y m2 hay rozamiento (considere $\mu_e$ = 0.4 ; $\mu_d$ = 0.2), no lo hay entre la manzana con masa m$_2$ y la superficie sobre la que está
...
\eje [5.8] Un bloque de 2.0 kg se coloca encima de otro de 5.0 kg como muestra la figura. El coeficiente
